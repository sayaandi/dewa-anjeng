...
<option value="0"'; if ($detailaduan[0]['status']=='0'){echo "selected";}
echo'>Menunggu</option>
<option value="proses"'; if ($detailaduan[0]['status']=='proses'){echo "selected";}
echo'>Proses</option>
<option value="selesai"'; if ($detailaduan[0]['status']=='selesai'){echo "selected";}
echo'>Selesai</option>
</select>
</div>
  <div class="col-auto">
